# -*- coding: utf-8 -*-
"""christina_training_bigmodel.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PoF6RG9exYQMmECzJejvYotBooZDevaQ
"""
...
arguments = TrainingArguments(
    output_dir="sample_hf_trainer_all",
...
finetuned_model = AutoModelForSequenceClassification.from_pretrained("/content/sample_hf_trainer_all/checkpoint-417")

from google.colab import drive
drive.mount('/content/drive')

dct_all = load_dataset('chiarab/uk', use_auth_token=True)
import torch
neg = 0
neu = 0
pos = 0
...
baseline_model = AutoModelForSequenceClassification.from_pretrained("cardiffnlp/twitter-roberta-base-sentiment", num_labels = 3)
...
dct_all = load_dataset('chiarab/dct-keyword-all', use_auth_token=True)
