# -*- coding: utf-8 -*-
"""Elyse of with10extra_training_model_CS224Nfinalproj_march12.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1hTNiNOLzgY1dILABgul_l4QYNMrDVE4d
"""
...
# Prepare the regular dataset - this tokenizes the dataset in batches of 16 examples.
...
from datasets import load_dataset, DatasetDict
tweets = load_dataset('chiarab/vaccine-keyword-all', use_auth_token=True)

tweets

import torch
# code to get predictions on unlabeled data
...
for inputs in finetune['test']['0']: # these are the tweet texts from the test set
  tokenized_inputs = tokenizer(inputs, return_tensors="pt")
  outputs = model(**tokenized_inputs)
  y_pred.append(torch.argmax(outputs.logits)) # add this prediction to list of predictions

y_true = finetune['test']['1'] # list of true predictions from the test set
