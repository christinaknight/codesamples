...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = nn.LSTM(embed_size, self.hidden_size, dropout = dropout_rate, bidirectional = True, bias = True)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y, 1):
            ...
            next = self.step(Ybar_t, dec_state, enc_hiddens, enc_hiddens_proj, enc_masks)
            dec_state = next[0]
            o_t = next[1]
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        tan_V_t = torch.tanh(V_t)
        O_t = self.dropout(tan_V_t)
